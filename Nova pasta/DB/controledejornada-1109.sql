...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09-Nov-2020 às 21:56
...
INSERT INTO `motorista` (`motcod`, `motnome`, `motrua`, `motbairro`, `motcidade`, `motestado`, `motemail`, `motsenha`, `motfone`, `motcpf`, `motrg`, `motcnh`, `motdtadmissao`, `motdtafast`, `motsituacao`) VALUES
(1, 'Joao Teste', 'Rua Abcde', 'Bairro Testando', 'Pato Branco', 'PR', 'viniciusteste@teste.com', '123456', '46 000000000', '06789384901', '45345435', '23434654654', '05/05/2000', '05/07/2010', '1'),
(2, 'José Santos', 'Rua AXYZ', 'Bairro Testando 2', 'Francisco Beltrão', 'PR', 'joseteste@teste.com', '1234', '46 000000001', '06789384902', '453454357', '3453454354', '01/05/2000', '05/07/2012', '1');
...
--
ALTER TABLE `motorista`
  MODIFY `motcod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `regrasjornada`
--
ALTER TABLE `regrasjornada`
  MODIFY `rjocod` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `regrasjornada`
  ADD CONSTRAINT `fk_regrasjornada_tpveiculo1` FOREIGN KEY (`tpveiculo_tpvcod`) REFERENCES `controledeestoque`.`tpveiculo` (`tpvcod`) ON DELETE NO ACTION ON UPDATE NO ACTION;
