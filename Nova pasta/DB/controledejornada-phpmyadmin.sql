...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Nov-2020 às 21:48
...
CREATE TABLE `motorista` (
  ...
  `usuario_usucod` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `motorista`
  ...
  ADD KEY `fk_motorista_usuario1_idx` (`usuario_usucod`);
...
--
ALTER TABLE `escopo`
  MODIFY `esccod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `motorista`
  ADD CONSTRAINT `fk_motorista_usuario1` FOREIGN KEY (`usuario_usucod`) REFERENCES `usuario` (`usucod`) ON DELETE NO ACTION ON UPDATE NO ACTION;
