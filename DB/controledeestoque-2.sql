...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Nov-2020 às 21:59
...
CREATE TABLE `itens` (
  ...
  `DataVenci_Itens` datetime DEFAULT NULL,
...
CREATE TABLE `joresp` (
  ...
  `jorespinicial` datetime DEFAULT NULL,
  `jorespfinal` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `jorinter` (
  ...
  `jorinterinicial` datetime DEFAULT NULL,
  `jorinterfinal` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `jornada` (
  ...
  `jordia` varchar(45) DEFAULT NULL,
  `jorhorainicio` varchar(45) DEFAULT NULL,
  `jorhorafinal` varchar(45) DEFAULT NULL,
...
CREATE TABLE `jorref` (
  ...
  `jorrefinicial` datetime DEFAULT NULL,
  `jorreffinal` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
